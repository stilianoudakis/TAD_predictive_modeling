...
Recursive feature elimination was used to establish the optimal number of distance-type features to include in downstream analyses. It was determined that, for 10 kb resolution data, near optimal performance was obtained for models with only 32 predictors for each cell line (Figure 5). Results remained consistent across the other data resolutions (Supplementary Figure 4). Therefore, we reduced the feature space for subsequent models to the top 32 predictors, respective to resolution and cell line. The sets of top predictors chosen varied across resolution and cell line due to differences in the parameters provided in the TAD calling algorithm. For the 10 kb resolution data, the most important predictive features that were robust across cell lines were 
