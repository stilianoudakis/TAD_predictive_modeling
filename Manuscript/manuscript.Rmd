...
Using each genomic element, we created three types of predictors that were used as features to analyze their relationships with TAD boundaries in downstream modelling (Figure 2). The predictors consisted of two different types of overlaps, and a distance type. They are described in detail below:
