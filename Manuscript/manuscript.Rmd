...
The low baseline thresholds represented by the dashed line in the precision-recall curves (Figure 4 and Supplementary Figure2) indicate the wide disparity between majority and minority classes. Ideally a manageable dataset will have an imbalance ratio hovering near 1. However, in our study we found that there was an average imbalance ratio of 0.154 (SD=0.022) and 0.137 (SD=0.0181) for cell lines GM12878 and K562 respectively (Supplementary Figure 5).  This highlights the need for suitable resampling techniques. 
