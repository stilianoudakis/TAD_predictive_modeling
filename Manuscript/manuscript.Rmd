...
We first examined the class imbalance of the different data resolutions (Supplementary Table 5). [??? What table?; !!!fixed] While the total number of genomic bins decreased as resolution increased, the imbalance ratios remained relatively stable. We found that there was an average imbalance ratio of 0.154 (SD=0.022) and 0.137 (SD=0.0181) across resolutions for cell lines GM12878 and K562 respectively. [??? At which resolution?; !!!fixed] The low imbalance ratios indicate a wide disparity between majority and minority classes, and therefore suitable resampling techniques are needed.  
