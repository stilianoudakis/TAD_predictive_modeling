...
Genomic annotation data in the form of cell type-specific cis-regulatory elements (CSS), histone modifications (HM), and transcription factor binding sites (TFBS) were obtained from the UCSC Genome Browser Database (GRCh37/hg19 human genome assembly) [@Tyner:2017aa] (Supplementary Table 2). 
