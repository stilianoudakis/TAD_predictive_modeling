...
To assess the predictive performance for each predictor type, we performed individual random forest models utilizing each specific predictor type, in addition to a model with all combined types. Precision-Recall (PR) Curves, and subsequent area under the PR curves (AUPRC), were used to evaluate which predictor type contributed to the best model performance.
