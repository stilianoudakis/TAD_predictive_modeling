...
Given the prevalence of TFBS as the most consistently top ranked predictive features across resolution and cell line, we ventured to further compare performances of annotation specific models. After applying SMOTE re-sampling with distance type predictors, random forest models built on sets of histone modifications, chromatin state segmentations, and TFBS were compared to a model that included all three types together. For the GM12878 cell line, models built simply on TFBS were found to perform just as well as models that included all 3 sets of annotations according to F1-Score and MCC, consistently across resolution (Figure 6). Similar results were found when evaluating the K562 cell line (supplementary Figure 11).
