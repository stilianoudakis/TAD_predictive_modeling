...
Distance profiles on a $log_{2}$ scale were found to exhibit significantly different densities between classes of genomic bins for TFBS with highly ranked predictive importances. Using permutation tests we found that the transcription factors SMC3a, ZNF143, CTCF, and RAD21 tended to have binding peaks that that were located closer to the centers of 10 kb sized genomic bins that overlapped with flanked TAD boundaries than to bins that did not overlap with flanked TAD boundaries across both cell lines (Figure 7 A-H). Similar distance profiles for the same TFBS were obtained when assessed at lower resolutions, across both cell lines (Supplementary Figures 12 & 13 A-L).
