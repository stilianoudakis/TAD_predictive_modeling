...
**Supplementary Figure 1. Distance Densities across cell lines and resolutions.**
Density curves of distances (in millions of base pairs) from genomic bins to flanked TAD boundaries for 10 kb (A), 25 kb (B), 50 kb (C), and 100 kb (D) data resolutions across the GM12878 (left column) and K562 (right column) cell lines. The untransformed distance densities are filled in red, while the $log_{2}$ tranformed distance densities are filled in blue.
