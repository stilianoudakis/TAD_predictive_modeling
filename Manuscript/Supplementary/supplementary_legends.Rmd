...
**Supplementary Figure 2B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 10 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 2C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 10 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 3A. Correlograms separated by genomic annotation category for overlap count predictor types, using 25 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 3B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 25 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 3C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 25 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 4A. Correlograms separated by genomic annotation category for overlap count predictor types, using 50 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 4B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 50 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 4C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 50 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 5A. Correlograms separated by genomic annotation category for overlap count predictor types, using 100 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 5B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 100 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 5C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 100 kb resolution data, on the GM12878 cell line** 

**Supplementary Figure 6A. Correlograms separated by genomic annotation category for overlap count predictor types, using 10 kb resolution data, on the K562 cell line** 

**Supplementary Figure 6B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 10 kb resolution data, on the K562 cell line** 

**Supplementary Figure 6C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 10 kb resolution data, on the K562 cell line** 

**Supplementary Figure 7A. Correlograms separated by genomic annotation category for overlap count predictor types, using 25 kb resolution data, on the K562 cell line** 

**Supplementary Figure 7B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 25 kb resolution data, on the K562 cell line** 

**Supplementary Figure 7C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 25 kb resolution data, on the K562 cell line** 

**Supplementary Figure 8A. Correlograms separated by genomic annotation category for overlap count predictor types, using 50 kb resolution data, on the K562 cell line** 

**Supplementary Figure 8B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 50 kb resolution data, on the K562 cell line** 

**Supplementary Figure 8C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 50 kb resolution data, on the K562 cell line** 

**Supplementary Figure 9A. Correlograms separated by genomic annotation category for overlap count predictor types, using 100 kb resolution data, on the K562 cell line** 

**Supplementary Figure 9B. Correlograms separated by genomic annotation category for overlap percent predictor types, using 100 kb resolution data, on the K562 cell line** 

**Supplementary Figure 9C. Correlograms separated by genomic annotation category for $log_{2}$ distance predictor types, using 100 kb resolution data, on the K562 cell line** 


**Supplementary Figure 10A. Heatmap illustrating which features were regularized using Elastic-Net for 10 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 10B. Heatmap illustrating which features were regularized using Elastic-Net for 25 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 10C. Heatmap illustrating which features were regularized using Elastic-Net for 50 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 10D. Heatmap illustrating which features were regularized using Elastic-Net for 100 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 11A. Heatmap illustrating which features were regularized using Elastic-Net for 10 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 11B. Heatmap illustrating which features were regularized using Elastic-Net for 25 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 11C. Heatmap illustrating which features were regularized using Elastic-Net for 50 kb resolution data applied to the GM12878 cell line.**

**Supplementary Figure 11D. Heatmap illustrating which features were regularized using Elastic-Net for 100 kb resolution data applied to the GM12878 cell line.**
