...
**Figure 8. Predictive importance** A heatmap illustrating the importance of the top 20 most predictive transcription factors for random forest models implemented on SMOTE resampled data with distance-type predictors for GM12878. Importances were sorted according to the 10 kb resolution and rescaled to values between 0 and 100. Transcription factors with higher values of predictive importance are denoted in dark red.
