...
**Figure 4. Imbalance Ratios.** Boxplots illustrating the variations in imbalance ratios (IR) across cell line and resolution. IR was calculated by dividing the number of chromosome-specific genomic bins that overlapped with flanked TAD boundaries by the number of chromosome-specific genomic bins that did not. 
