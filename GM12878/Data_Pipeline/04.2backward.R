...
bwd.preds <- rownames(namesmat)[which(namesmat$naperc >= 95)]

bwd.preds

gm12878_5kb_bwd <- gm12878_5kb_f[,which((names(gm12878_5kb_f) %in% bwd.preds) | names(gm12878_5kb_f)=="y")]

dim(gm12878_5kb_bwd)

saveRDS(gm12878_5kb_bwd,"gm12878_5kb_bwd.rds")
