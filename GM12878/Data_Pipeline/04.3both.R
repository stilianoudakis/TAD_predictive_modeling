...
gm12878_5kb_both <- gm12878_5kb_f[,which((names(gm12878_5kb_f) %in% both.preds) | names(gm12878_5kb_f)=="y")]

dim(gm12878_5kb_both)

saveRDS(gm12878_5kb_both,"gm12878_5kb_both.rds")
