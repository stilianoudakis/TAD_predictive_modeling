...
- Biological properties of domain boundaries predicted using *preciseTAD* include the highest genomic signal of CTCF and other transcription factors, closer proximity to other genomic signatures, and higher` conservation across cell lines.
