...
```{r}
ggplot(all_rfperfs[all_rfperfs$CL=="GM12878",], aes(x=Resolution, y=V1, color=Predictor, fill=Predictor)) +
     #geom_line(size=2, position=position_dodge(0.5))+
     #geom_point(size=5, position=position_dodge(0.5))+
     #geom_errorbar(aes(ymin=MCC-MCCSD, ymax=MCC+MCCSD), width=1,
     #             position=position_dodge(0.5)) +
...
```{r}
ggplot(all_rfperfs[all_rfperfs$CL=="K562",], aes(x=Resolution, y=V1, color=Predictor, fill=Predictor)) +
     #geom_line(size=2, position=position_dodge(0.5))+
     #geom_point(size=5, position=position_dodge(0.5))+
     #geom_errorbar(aes(ymin=MCC-MCCSD, ymax=MCC+MCCSD), width=1,
     #             position=position_dodge(0.5)) +
...
```{r}
ggplot(all_rfperfs_mcc[all_rfperfs_mcc$CL=="GM12878",], aes(x=Resolution, y=MCC, color=Predictor, fill=Predictor, group=Predictor)) +
     geom_bar(stat="identity", position = position_dodge()) +
     geom_errorbar(aes(ymin=MCC-MCCSD, ymax=MCC+MCCSD), width=.75,
...
```{r}
ggplot(all_rfperfs_mcc[all_rfperfs_mcc$CL=="K562",], aes(x=Resolution, y=MCC, color=Predictor, fill=Predictor, group=Predictor)) +
     geom_bar(stat="identity", position = position_dodge()) +
     geom_errorbar(aes(ymin=MCC-MCCSD, ymax=MCC+MCCSD), width=.75,
                 position=position_dodge(.9), alpha=0.75, color="black", size=1) +
     facet_grid(. ~ Resampling)+
