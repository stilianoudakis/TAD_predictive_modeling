...
a <- ggplot(bounds_df[which(bounds_df$res=="10kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  ...
  scale_y_continuous(limits = c(0,27000),
                     ...
                     labels=c("0"="0", "10000"="10", "20000"="20")) +
  ggtitle("10 kb") +
  guides(fill=FALSE) +
  theme(axis.text.x = element_text(size=15),
     axis.text.y = element_text(size = 15),
...
```{r}
a <- ggplot(irtab[which(irtab$res=="10kb"),], aes(x=cl, y = pi, fill=cl, color=cl))  + 
 stat_boxplot(geom ='errorbar', width = 0.2) + 
 geom_boxplot() +
 theme_minimal() +
 theme_bw()+
...
b <- ggplot(irtab[which(irtab$res=="25kb"),], aes(x=cl, y = pi, fill=cl, color=cl))  + 
 stat_boxplot(geom ='errorbar', width = 0.2) + 
 geom_boxplot() +
 theme_minimal() +
 theme_bw()+
...
c <- ggplot(irtab[which(irtab$res=="50kb"),], aes(x=cl, y = pi, fill=cl, color=cl))  + 
 stat_boxplot(geom ='errorbar', width = 0.2) + 
 geom_boxplot() +
 theme_minimal() +
 theme_bw()+
...
d <- ggplot(irtab[which(irtab$res=="100kb"),], aes(x=cl, y = pi, fill=cl, color=cl))  + 
 stat_boxplot(geom ='errorbar', width = 0.2) + 
 geom_boxplot() +
 theme_minimal() +
 theme_bw()+
