...
```{r}
a <- ggplot(bounds_df[which(bounds_df$res=="5kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  geom_bar(stat="identity", position="dodge")+
  theme_minimal() +
  theme_bw()+
  xlab("") + ylab("") + ylim(0,30000) +
  scale_fill_discrete(name="Cell Line") +
  scale_y_continuous(limits = c(0,30000),
                     breaks=c(0,10000,20000,30000),
                     labels=c("0"="0", "10000"="10", "20000"="20", "30000"="30")) +
  ggtitle("5 kb") +
  guides(fill=FALSE) +
  theme(axis.text.x = element_text(size=15,
                                      angle = 45, 
...
b <- ggplot(bounds_df[which(bounds_df$res=="10kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  geom_bar(stat="identity", position="dodge")+
  theme_minimal() +
  theme_bw()+
  xlab("") + ylab("") + ylim(0,30000) +
...
c <- ggplot(bounds_df[which(bounds_df$res=="25kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  geom_bar(stat="identity", position="dodge")+
  theme_minimal() +
  theme_bw()+
  xlab("") + ylab("") + ylim(0,30000) +
...
d <- ggplot(bounds_df[which(bounds_df$res=="50kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  geom_bar(stat="identity", position="dodge")+
  theme_minimal() +
  theme_bw()+
  xlab("") + ylab("") + ylim(0,30000) +
...
e <- ggplot(bounds_df[which(bounds_df$res=="100kb"),], aes(x=cl, y=TotBounds, fill=cl))+
  geom_bar(stat="identity", position="dodge")+
  theme_minimal() +
  theme_bw()+
  xlab("") + ylab("") + ylim(0,30000) +
...
annotate_figure(figure,
    ...
    left = text_grob("Number of TAD Boundary\nRegions (thousands)", color = "black", rot = 90, size=20)
)
