...
enet_ratios_gm12878_summ$Resolution <- factor(enet_ratios_gm12878_summ$Resolution, levels=c("10 kb", "25 kb", "50 kb", "100 kb"))

ggplot(enet_ratios_gm12878_summ, aes(fill=Annotation, y=AveRatio, x=Resolution)) + 
    geom_bar(stat="identity", position = position_dodge()) +
    geom_errorbar(aes(ymin=AveRatio-AveRatioSD, ymax=AveRatio+AveRatioSD), width=.5,
                 position=position_dodge(.9), alpha=0.75) +
    xlab("Resolution") +
    ylab("Proportion of Features in Final Model") +
