...
#alpha
ggplot(penal_params_gm12878_summ, aes(x=Resolution, y=alpha, color=Resampling, group=Resampling)) +
...
#lambda
ggplot(penal_params_gm12878_summ, aes(x=Resolution, y=lambda, color=Resampling, group=Resampling)) +
     geom_line(size=2, position=position_dodge(0.5))+
     geom_point(size=5, position=position_dodge(0.5))+
