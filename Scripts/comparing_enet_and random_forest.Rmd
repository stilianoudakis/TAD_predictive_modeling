...
ggplot(all_enetperfs_mcc, aes(x=Resolution, y=MCC, color=Resampling, group=Resampling)) +
...
ggplot(all_enetperfs_f1, aes(x=Resolution, y=F1, color=Resampling, group=Resampling)) +
     geom_line(size=2, position=position_dodge(0.5))+
     geom_point(size=5, position=position_dodge(0.5))+
...
ggplot(all_enetperfs_auprc, aes(x=Resolution, y=AUPRC, color=Resampling, group=Resampling)) +
     geom_line(size=2, position=position_dodge(0.5))+
     geom_point(size=5, position=position_dodge(0.5))+
