...
ggplot(all_dist_gm12878, aes(x = Resolution, y = value, fill = y)) +
  ...
  ylab("Log2 Distances") +
  ylim(5,25) +
  scale_fill_discrete(name="Class of Genomic Bin",
...
ggplot(all_dist_K562, aes(x = Resolution, y = value, fill = y)) +
  stat_boxplot(geom = "errorbar") +
  geom_boxplot(#fill = fill, 
               #colour = line,
               outlier.shape = NA) +
