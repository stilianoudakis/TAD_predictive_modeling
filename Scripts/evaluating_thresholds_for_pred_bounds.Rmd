---
title: "Evaluating Thresholds for Predicted TAD Boundary Regions"
...
```{r}
toptfbs_mean_gm12878_chr21 <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/results_by_chr/CHR21/smote/distance/enet/called_and_pred_bound_regions.rds")
...
res <- makeVennDiagram(Peaks=list(toptfbs_mean_gm12878_chr21[[3]], toptfbs_mean_gm12878_chr21[[4]]),
                       NameOfPeaks=c("Called", "Predicted"),
                       connectedPeaks = "keepAll")
venn_gm12878_22 <- venn_cnt2venn(res$vennCounts)
venn_gm12878_22 <- compute.Venn(venn_gm12878_22)
...
sh <- unique(subjectHits(findOverlaps(toptfbs_mean_gm12878_chr21[[3]], toptfbs_mean_gm12878_chr21[[4]])))
pbnc <- toptfbs_mean_gm12878_chr21[[4]][-sh]

pbnc_to_ctcf <- GenometriCorrelation(pbnc,
                                     annots.GR[[1]][seqnames(annots.GR[[1]])=="chr21"], 
                                     chromosomes.length = max(end(pbnc),
                                                              end(annots.GR[[1]][seqnames(annots.GR[[1]])=="chr21"])),
                                     chromosomes.to.proceed = "chr21", 
                                     permut.number = 100,
                                     ecdf.area.permut.number = 100,
                                     mean.distance.permut.number = 100,
                                     jaccard.measure.permut.number = 100,
...
pbnc_to_rad21 <- GenometriCorrelation(pbnc,
                                      annots.GR[[2]][seqnames(annots.GR[[2]])=="chr21"], 
                                      chromosomes.length = max(end(pbnc),
                                                               end(annots.GR[[2]][seqnames(annots.GR[[2]])=="chr21"])),
                                      chromosomes.to.proceed = "chr21", 
                                      permut.number = 100,
                                      ecdf.area.permut.number = 100,
                                      mean.distance.permut.number = 100,
...
pbnc_to_smc3a <- GenometriCorrelation(pbnc,
                                      annots.GR[[3]][seqnames(annots.GR[[3]])=="chr21"], 
                                      chromosomes.length = max(end(pbnc),
                                                               end(annots.GR[[3]][seqnames(annots.GR[[3]])=="chr21"])),
                                      chromosomes.to.proceed = "chr21", 
                                      permut.number = 100,
                                      ecdf.area.permut.number = 100,
                                      mean.distance.permut.number = 100,
...
pbnc_to_znf143 <- GenometriCorrelation(pbnc,
                                       annots.GR[[4]][seqnames(annots.GR[[4]])=="chr21"], 
                                       chromosomes.length = max(end(pbnc),
                                                                end(annots.GR[[4]][seqnames(annots.GR[[4]])=="chr21"])),
                                       chromosomes.to.proceed = "chr21", 
                                       permut.number = 100,
                                       ecdf.area.permut.number = 100,
                                       mean.distance.permut.number = 100,
...
#PAC
sh <- unique(subjectHits(findOverlaps(toptfbs_mean_gm12878_chr21[[3]], toptfbs_mean_gm12878_chr21[[4]])))
pac <- toptfbs_mean_gm12878_chr21[[4]][sh]
...
#CAP
qh <- unique(queryHits(findOverlaps(toptfbs_mean_gm12878_chr21[[3]], toptfbs_mean_gm12878_chr21[[4]])))
cap <- toptfbs_mean_gm12878_chr21[[3]][qh]
...
#CBNP
qh <- unique(queryHits(findOverlaps(toptfbs_mean_gm12878_chr21[[3]], toptfbs_mean_gm12878_chr21[[4]])))
cbnp <- toptfbs_mean_gm12878_chr21[[3]][-qh]
