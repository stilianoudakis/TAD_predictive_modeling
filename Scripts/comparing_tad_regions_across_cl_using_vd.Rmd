...
res <- makeVennDiagram(Peaks=list(binslist_gm12878_5kb, binslist_K562_5kb),
                       NameOfPeaks=c("GM12878", "K562"))
...
res <- makeVennDiagram(Peaks=list(binslist_gm12878_10kb, binslist_K562_10kb),
                       NameOfPeaks=c("GM12878", "K562"))
...
res <- makeVennDiagram(Peaks=list(binslist_gm12878_25kb, binslist_K562_25kb),
                       NameOfPeaks=c("GM12878", "K562"))
...
res <- makeVennDiagram(Peaks=list(binslist_gm12878_50kb, binslist_K562_50kb),
                       NameOfPeaks=c("GM12878", "K562"))
...
res <- makeVennDiagram(Peaks=list(binslist_gm12878_100kb, binslist_K562_100kb),
                       NameOfPeaks=c("GM12878", "K562"))
...
gridExtra::grid.arrange(grid::grid.grabExpr(plot(venn_5kb, gp = gp, show=list(Universe=FALSE))), top=textGrob("5 kb", gp=gpar(fontsize=20)))
grid.newpage()
gridExtra::grid.arrange(grid::grid.grabExpr(plot(venn_10kb, gp = gp, show=list(Universe=FALSE))), top=textGrob("10 kb", gp=gpar(fontsize=20)))
grid.newpage()
gridExtra::grid.arrange(grid::grid.grabExpr(plot(venn_25kb, gp = gp, show=list(Universe=FALSE))), top=textGrob("25 kb", gp=gpar(fontsize=20)))
grid.newpage()
gridExtra::grid.arrange(grid::grid.grabExpr(plot(venn_50kb, gp = gp, show=list(Universe=FALSE))), top=textGrob("50 kb", gp=gpar(fontsize=20)))
grid.newpage()
gridExtra::grid.arrange(grid::grid.grabExpr(plot(venn_100kb, gp = gp, show=list(Universe=FALSE))), top=textGrob("100 kb", gp=gpar(fontsize=20)))
grid.newpage()
