...
annotname <- gsub(paste(c("`", 
             ...
             "Uw",
             "Broad",
             "Uchicago"), collapse = "|"), "", "K562-Ctcf-Broad_dist")
...
p.K562.10kb.ctcf <- ggplot(annotdata.ctcf, aes(x=Ctcf_dist, color=y)) +
    geom_density() +
    scale_color_discrete(name="Class of\nGenomic Bin",
                         labels=c("Does not overlap\nw/ flanked TAD boundary", "Overlapped w/\nflanked TAD boundary")) +
    ylab("") +
...
p.K562.25kb.ctcf <- ggplot(annotdata.ctcf, aes(x=Ctcf_dist, color=y)) +
    geom_density() +
    scale_color_discrete(name="Class of\nGenomic Bin",
                         labels=c("Does not overlap\nw/ flanked TAD boundary", "Overlapped w/\nflanked TAD boundary")) +
    ylab("") +
...
p.K562.50kb.ctcf <- ggplot(annotdata.ctcf, aes(x=Ctcf_dist, color=y)) +
    geom_density() +
    scale_color_discrete(name="Class of\nGenomic Bin",
                         labels=c("Does not overlap\nw/ flanked TAD boundary", "Overlapped w/\nflanked TAD boundary")) +
    ylab("") +
...
p.K562.100kb.ctcf <- ggplot(annotdata.ctcf, aes(x=Ctcf_dist, color=y)) +
    geom_density() +
    scale_color_discrete(name="Class of\nGenomic Bin",
                         labels=c("Does not overlap\nw/ flanked TAD boundary", "Overlapped w/\nflanked TAD boundary")) +
    ylab("") +
