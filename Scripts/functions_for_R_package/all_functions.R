...
#DEPRECATED (included in the predict_tad_bounds_func)
...
#old version of predict_tad_bounds_func
...
#new version of predict_tad_bounds_func; combines old (how response vector is created) and new (how feature space is created)
##function to predict cl, resolution, and chromosome specific tad boundaries using optimal parameters
predict_tad_bounds_func_new_V2 <- function(resolution, bounds.GR, annotationListGR, chromosome, predictortype=predictor, sampling="smote", metric="MCC", seed=123, crossvalidation=TRUE, number=10){
  resolution=as.integer(resolution)
