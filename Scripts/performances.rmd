...
prall <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/Ensemble/None/op/RFE/prcurve.rds")

#plot(prall, auc.main= FALSE, legend=FALSE, col='black', panel.first= grid(), cex.main = 1.5, rand.plot = TRUE)
plot(prall$curve, auc.main= FALSE, legend=FALSE, col='black', panel.first= grid(), cex.main = 1.5, type="l", ylim=c(0,1), lwd=2, xlab="Recall", ylab="Precision")
lines(prdist$curve, auc.main= FALSE, legend=FALSE, col='red', panel.first= grid(), cex.main = 1.5, type="l", ylim=c(0,1), lwd=2, xlab="Recall", ylab="Precision")#, add=TRUE)
lines(proc$curve, auc.main= FALSE, legend=FALSE, col='blue', panel.first= grid(), cex.main = 1.5, type="l",lwd=2, add=TRUE)
lines(prop$curve, auc.main= FALSE, legend=FALSE, col='green', panel.first= grid(), cex.main = 1.5, type="l", ylim=c(0,1), lwd=2, add=TRUE)
...
prall <- readRDS("Z:/TAD_data_analysis/GM12878/25kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/GM12878/25kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/GM12878/25kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/GM12878/25kb/Ensemble/None/op/RFE/prcurve.rds")
...
prall <- readRDS("Z:/TAD_data_analysis/GM12878/50kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/GM12878/50kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/GM12878/50kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/GM12878/50kb/Ensemble/None/op/RFE/prcurve.rds")
...
prall <- readRDS("Z:/TAD_data_analysis/GM12878/100kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/GM12878/100kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/GM12878/100kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/GM12878/100kb/Ensemble/None/op/RFE/prcurve.rds")
...
```{r}
prall <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/op/RFE/prcurve.rds")
...
#legend("topright", title="Predictor Type", legend=c("Distance (AUPRC: )","All (AUPRC: )", "Percents (AUPRC: )", "Counts (AUPRC: )", "Baseline"),
#       col=c("red", "black", "green", "blue", "black"), lty=c(1,1,1,1,2), lwd=c(3,3,3,3,1), cex=0.8)
...
```{r}
prall <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/op/RFE/prcurve.rds")
...
```{r}
prall <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/op/RFE/prcurve.rds")
...
```{r}
prall <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/all/RFE/prcurve.rds")
prdist <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/oc/RFE/prcurve.rds")
prop <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/op/RFE/prcurve.rds")
...
prall_k562 <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/all/RFE/prcurve.rds")
prdist_k562 <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc_k562 <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/oc/RFE/prcurve.rds")
prop_k562 <- readRDS("Z:/TAD_data_analysis/K562/10kb/Ensemble/None/op/RFE/prcurve.rds")

prdata_10kb <- rbind.data.frame(prall$curve,
                                prdist$curve,
                                prop$curve,
                                proc$curve,
                                prall_k562$curve,
                                ...
                                prop_k562$curve,
                                proc_k562$curve)
names(prdata_10kb) <- c("Recall", "Precision", "Threshold")
prdata_10kb$Predictor <- c(rep("All", dim(prall$curve)[1]),
                           rep("Distance", dim(prdist$curve)[1]),
                           rep("OP", dim(prop$curve)[1]),
                           rep("OC", dim(proc$curve)[1]),
                           rep("All", dim(prall_k562$curve)[1]),
                           rep("Distance", dim(prdist_k562$curve)[1]),
                           rep("OP", dim(prop_k562$curve)[1]),
                           rep("OC", dim(proc_k562$curve)[1]))
prdata_10kb$CL <- c(rep("GM12878", (dim(prall$curve)[1]+
                                      dim(prdist$curve)[1]+
                                      dim(prop$curve)[1]+
                                      dim(proc$curve)[1])),
                    rep("K562", (dim(prall_k562$curve)[1]+
                                      dim(prdist_k562$curve)[1]+
                                      dim(prop_k562$curve)[1]+
                                      dim(proc_k562$curve)[1])))
prdata_10kb$Predictor <- factor(prdata_10kb$Predictor)
prdata_10kb$CL <- factor(prdata_10kb$CL)

prplot_10kb <- ggplot(prdata_10kb, aes(x=Recall, y=Precision, color=Predictor, linetype=CL)) +
  geom_line(size=.75)+
...
prall_k562 <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/all/RFE/prcurve.rds")
prdist_k562 <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc_k562 <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/oc/RFE/prcurve.rds")
prop_k562 <- readRDS("Z:/TAD_data_analysis/K562/25kb/Ensemble/None/op/RFE/prcurve.rds")

prdata_25kb <- rbind.data.frame(prall$curve,
                                prdist$curve,
                                prop$curve,
                                proc$curve,
                                prall_k562$curve,
                                ...
                                prop_k562$curve,
                                proc_k562$curve)
names(prdata_25kb) <- c("Recall", "Precision", "Threshold")
prdata_25kb$Predictor <- c(rep("All", dim(prall$curve)[1]),
                           rep("Distance", dim(prdist$curve)[1]),
                           rep("OP", dim(prop$curve)[1]),
                           rep("OC", dim(proc$curve)[1]),
                           rep("All", dim(prall_k562$curve)[1]),
                           ...
                           rep("OP", dim(prop_k562$curve)[1]),
                           rep("OC", dim(proc_k562$curve)[1]))
prdata_25kb$CL <- c(rep("GM12878", (dim(prall$curve)[1]+
                                      dim(prdist$curve)[1]+
                                      dim(prop$curve)[1]+
                                      dim(proc$curve)[1])),
                    rep("K562", (dim(prall_k562$curve)[1]+
                                      ...
                                      dim(prop_k562$curve)[1]+
                                      dim(proc_k562$curve)[1])))
prdata_25kb$Predictor <- factor(prdata_25kb$Predictor)
prdata_25kb$CL <- factor(prdata_25kb$CL)

prplot_25kb <- ggplot(prdata_25kb, aes(x=Recall, y=Precision, color=Predictor, linetype=CL)) +
  geom_line(size=.75)+
  scale_linetype_manual(name=("Cell Line"), values=c("solid", "dashed"))+
  scale_color_discrete(name = "Predictor Type") +
  theme_minimal()+
...
prall_k562 <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/all/RFE/prcurve.rds")
prdist_k562 <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc_k562 <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/oc/RFE/prcurve.rds")
prop_k562 <- readRDS("Z:/TAD_data_analysis/K562/50kb/Ensemble/None/op/RFE/prcurve.rds")

prdata_50kb <- rbind.data.frame(prall$curve,
                                prdist$curve,
                                prop$curve,
                                proc$curve,
                                prall_k562$curve,
                                ...
                                prop_k562$curve,
                                proc_k562$curve)
names(prdata_50kb) <- c("Recall", "Precision", "Threshold")
prdata_50kb$Predictor <- c(rep("All", dim(prall$curve)[1]),
                           rep("Distance", dim(prdist$curve)[1]),
                           rep("OP", dim(prop$curve)[1]),
                           rep("OC", dim(proc$curve)[1]),
                           rep("All", dim(prall_k562$curve)[1]),
                           ...
                           rep("OP", dim(prop_k562$curve)[1]),
                           rep("OC", dim(proc_k562$curve)[1]))
prdata_50kb$CL <- c(rep("GM12878", (dim(prall$curve)[1]+
                                      dim(prdist$curve)[1]+
                                      dim(prop$curve)[1]+
                                      dim(proc$curve)[1])),
                    rep("K562", (dim(prall_k562$curve)[1]+
                                      ...
                                      dim(prop_k562$curve)[1]+
                                      dim(proc_k562$curve)[1])))
prdata_50kb$Predictor <- factor(prdata_50kb$Predictor)
prdata_50kb$CL <- factor(prdata_50kb$CL)

prplot_50kb <- ggplot(prdata_50kb, aes(x=Recall, y=Precision, color=Predictor, linetype=CL)) +
  geom_line(size=.75)+
  scale_linetype_manual(name=("Cell Line"), values=c("solid", "dashed"))+
  scale_color_discrete(name = "Predictor Type") +
  theme_minimal()+
...
prall_k562 <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/all/RFE/prcurve.rds")
prdist_k562 <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/Distance/RFE/prcurve.rds")
proc_k562 <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/oc/RFE/prcurve.rds")
prop_k562 <- readRDS("Z:/TAD_data_analysis/K562/100kb/Ensemble/None/op/RFE/prcurve.rds")

prdata_100kb <- rbind.data.frame(prall$curve,
                                prdist$curve,
                                prop$curve,
                                proc$curve,
                                prall_k562$curve,
                                ...
                                prop_k562$curve,
                                proc_k562$curve)
names(prdata_100kb) <- c("Recall", "Precision", "Threshold")
prdata_100kb$Predictor <- c(rep("All", dim(prall$curve)[1]),
                           rep("Distance", dim(prdist$curve)[1]),
                           rep("OP", dim(prop$curve)[1]),
                           rep("OC", dim(proc$curve)[1]),
                           rep("All", dim(prall_k562$curve)[1]),
                           ...
                           rep("OP", dim(prop_k562$curve)[1]),
                           rep("OC", dim(proc_k562$curve)[1]))
prdata_100kb$CL <- c(rep("GM12878", (dim(prall$curve)[1]+
                                      dim(prdist$curve)[1]+
                                      dim(prop$curve)[1]+
                                      dim(proc$curve)[1])),
                    rep("K562", (dim(prall_k562$curve)[1]+
                                      ...
                                      dim(prop_k562$curve)[1]+
                                      dim(proc_k562$curve)[1])))
prdata_100kb$Predictor <- factor(prdata_100kb$Predictor)
prdata_100kb$CL <- factor(prdata_100kb$CL)

prplot_100kb <- ggplot(prdata_100kb, aes(x=Recall, y=Precision, color=Predictor, linetype=CL)) +
  geom_line(size=.75)+
  scale_linetype_manual(name=("Cell Line"), values=c("solid", "dashed"))+
  scale_color_discrete(name = "Predictor Type") +
  theme_minimal()+
...
ggarrange(prplot_25kb, prplot_50kb, prplot_100kb,
          nrow=2,ncol=2,
