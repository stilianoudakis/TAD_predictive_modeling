...
all_varimps_gm12878 <- all_varimps_gm12878[order(rowMeans(all_varimps_gm12878[,-1]), decreasing = TRUE),]
...
all_varimps_K562 <- all_varimps_K562[order(rowMeans(all_varimps_K562[,-1]), decreasing = TRUE),]
...
chromstates_gm12878_plot <- ggplot(all_varimps_gm12878, aes(variable, ordered(Feature, levels=rev(unique(Feature))))) + 
  geom_tile(aes(fill = value), colour = "white") + 
  xlab("") +
  ylab("") +
  scale_fill_gradient2(limits=c(0,100),
...
chromstates_K562_plot <- ggplot(all_varimps_K562, aes(variable, ordered(Feature, levels=rev(unique(Feature))))) + 
  geom_tile(aes(fill = value), colour = "white") + 
  xlab("") +
  ylab("") +
  scale_fill_gradient2(limits=c(0,100),
...
figure <- ggarrange(chromstates_gm12878_plot,
                    chromstates_K562_plot,
                ncol = 2, nrow = 1, 
                common.legend = TRUE, 
                legend = "right",
                labels = "AUTO",
...
annotate_figure(figure,
    ...
    left = text_grob("Chromatin States", color = "black", rot = 90, size=20)
)
...
histones_gm12878_plot <- ggplot(all_varimps_gm12878, aes(variable, ordered(Feature, levels=rev(unique(Feature))))) + 
  geom_tile(aes(fill = value), colour = "white") + 
  xlab("") +
  ylab("") +
  scale_fill_gradient2(limits=c(0,100),
...
histones_K562_plot <- ggplot(all_varimps_K562, aes(variable, ordered(Feature, levels=rev(unique(Feature))))) + 
  geom_tile(aes(fill = value), colour = "white") + 
  xlab("") +
  ylab("") +
  scale_fill_gradient2(limits=c(0,100),
...
figure <- ggarrange(histones_gm12878_plot,
                    histones_K562_plot,
                ncol = 2, nrow = 1, 
                common.legend = TRUE, 
                legend = "right",
...
annotate_figure(figure,
    bottom = text_grob("Resolution", color = "black", size = 20),
    left = text_grob("Histone Modifications", color = "black", rot = 90, size=20)
)
