...
```{r}
annots <- list.files("Z:/TAD_data_analysis/annotations/BroadHMM")
annots <- annots[grep("Gm12878", annots)]
...
```{r}
annots <- list.files("Z:/TAD_data_analysis/annotations/BroadHMM")
annots <- annots[grep("K562", annots)]
...
```{r}
annots <- list.files("Z:/TAD_data_analysis/annotations/HistoneModifications")
annots <- annots[grep("Gm12878", annots)]
annots <- gsub(paste(c("Gm12878-",".bed"), collapse = "|"), "", annots)
