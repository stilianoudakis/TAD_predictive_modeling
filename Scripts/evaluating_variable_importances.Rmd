...
```{r}
#GM12878
all_varimps_gm12878_tfbs <- cbind.data.frame(varimp_gm12878_10kb$Feature,
...
names(all_varimps_gm12878_tfbs) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
...
#K562
all_varimps_K562_tfbs <- cbind.data.frame(varimp_K562_10kb$Feature,
                                        varimp_K562_10kb$aveimp10kb,
                                        varimp_K562_25kb$aveimp25kb,
                                        varimp_K562_50kb$aveimp50kb,
                                        varimp_K562_100kb$aveimp100kb)
names(all_varimps_K562_tfbs) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
...
```{r}
#GM12878
all_varimps_gm12878_chromstates <- cbind.data.frame(varimp_gm12878_10kb$Feature,
                                        varimp_gm12878_10kb$aveimp10kb,
                                        varimp_gm12878_25kb$aveimp25kb,
                                        varimp_gm12878_50kb$aveimp50kb,
                                        varimp_gm12878_100kb$aveimp100kb)
names(all_varimps_gm12878_chromstates) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
...
#K562
all_varimps_K562_chromstates <- cbind.data.frame(varimp_K562_10kb$Feature,
                                        varimp_K562_10kb$aveimp10kb,
                                        varimp_K562_25kb$aveimp25kb,
                                        varimp_K562_50kb$aveimp50kb,
                                        varimp_K562_100kb$aveimp100kb)
names(all_varimps_K562_chromstates) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
...
```{r}
#GM12878
all_varimps_gm12878_histones <- cbind.data.frame(varimp_gm12878_10kb$Feature,
                                        varimp_gm12878_10kb$aveimp10kb,
                                        varimp_gm12878_25kb$aveimp25kb,
                                        varimp_gm12878_50kb$aveimp50kb,
                                        varimp_gm12878_100kb$aveimp100kb)
names(all_varimps_gm12878_histones) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
...
#K562
all_varimps_K562_histones <- cbind.data.frame(varimp_K562_10kb$Feature,
                                        varimp_K562_10kb$aveimp10kb,
                                        varimp_K562_25kb$aveimp25kb,
                                        varimp_K562_50kb$aveimp50kb,
                                        varimp_K562_100kb$aveimp100kb)
names(all_varimps_K562_histones) <- c("Feature", "ave10kb", "ave25kb", "ave50kb", "ave100kb")
