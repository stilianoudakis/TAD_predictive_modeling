...
#rfimpvars_gm12878_100kb_none <- rfimpvars_gm12878_100kb_none[19:1,]
...
rownames(vim.gm12878.smote) <- gsub("`","",rownames(vim.gm12878.smote))
...
rownames(vim.K562.smote) <- gsub("`","",rownames(vim.K562.smote))
...
rownames(vim.gm12878.RUS) <- gsub("`","",rownames(vim.gm12878.RUS))
...
rownames(vim.K562.RUS) <- gsub("`","",rownames(vim.K562.RUS))
...
rownames(vim.gm12878.ROS) <- gsub("`","",rownames(vim.gm12878.ROS))
...
rownames(vim.K562.ROS) <- gsub("`","",rownames(vim.K562.ROS))
...
rownames(vim.gm12878.none) <- gsub("`","",rownames(vim.gm12878.none))
...
rownames(vim.K562.none) <- gsub("`","",rownames(vim.K562.none))
...
```{r}
figure <- ggarrange(p1,p2,ncol=2,nrow=1,common.legend = TRUE, legend = "right", labels="AUTO")
figure
annotate_figure(figure,
    bottom = text_grob("Resolution", color = "black", size = 20),
    left = text_grob("Genomic Annotation", color = "black", rot = 90, size=20)
)

figure <- ggarrange(p3,p4,ncol=2,nrow=1,common.legend = TRUE, legend = "right", labels="AUTO")
figure
annotate_figure(figure,
    bottom = text_grob("Resolution", color = "black", size = 20),
    left = text_grob("Genomic Annotation", color = "black", rot = 90, size=20)
...
figure <- ggarrange(p5,p6,ncol=2,nrow=1,common.legend = TRUE, legend = "right", labels="AUTO")
figure
annotate_figure(figure,
    bottom = text_grob("Resolution", color = "black", size = 20),
    left = text_grob("Genomic Annotation", color = "black", rot = 90, size=20)
...
figure <- ggarrange(p7,p8,ncol=2,nrow=1,common.legend = TRUE, legend = "right", labels="AUTO")
figure
annotate_figure(figure,
    bottom = text_grob("Resolution", color = "black", size = 20),
    left = text_grob("Genomic Annotation", color = "black", rot = 90, size=20)
