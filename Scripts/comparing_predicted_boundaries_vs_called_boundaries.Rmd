...
EnrichedHeatmap(mat_pred_ctcf, 
                col = c("black",colorRampPalette(c("white", "pink", "red"))(99)), 
...
pred_v_called_10_df <- data.frame(LogDist = c(#Predicted
    ...
    #Called
    log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1),
    log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[2]]))$distance+1),
    log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[3]]))$distance+1),
    log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[4]]))$distance+1)
),
Annotation = c(#Predicted
    ...
    rep("SMC3",length(log2(mcols(distanceToNearest(all_pred_bounds, annots.GR.f[[1]]))$distance+1))),
    rep("ZNF143",length(log2(mcols(distanceToNearest(all_pred_bounds, annots.GR.f[[1]]))$distance+1))),
    
    #Called
    rep("CTCF",length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("RAD21",length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("SMC3",length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("ZNF143",length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1)))),
BoundReg = c(#Predicted
    ...
    #Called
    rep("Called", length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("Called", length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("Called", length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1))),
    rep("Called", length(log2(mcols(distanceToNearest(all_true_bounds_r, annots.GR.f[[1]]))$distance+1)))))
