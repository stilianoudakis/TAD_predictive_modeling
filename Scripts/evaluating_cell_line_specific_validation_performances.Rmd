...
```{r}
mccdata_gm12878_on_k562_5kb <- numeric()
...
for(i in paste0("CHR", c(1:8,10:22))){
		  ...
		  if("rfperf_tfbs_GM12878_on_K562.rds" %in% files){
			...
			mccdata_gm12878_on_k562_5kb <- rbind(mccdata_gm12878_on_k562_5kb,
			                                      perfdata[15,2])
}
...
```{r}
mccdata_k562_on_gm12878_5kb <- numeric()
...
for(i in paste0("CHR", c(1:8,10:22))){
		  ...
		  if("rfperf_tfbs_K562_on_GM12878.rds" %in% files){
			...
			mccdata_k562_on_gm12878_5kb <- rbind(mccdata_k562_on_gm12878_5kb,
			                                      perfdata[15,2])
}
...
```{r}
mccdata_gm12878_on_gm12878_5kb <- numeric()
...
for(i in paste0("CHR", c(1:8,10:22))){
		  ...
		  if("rfperf_tfbs.rds" %in% files){
			...
			mccdata_gm12878_on_gm12878_5kb <- rbind(mccdata_gm12878_on_gm12878_5kb,
			                                      perfdata[15,2])
}
...
```{r}
mccdata_k562_on_k562_5kb <- numeric()
...
for(i in paste0("CHR", c(1:8,10:22))){
		  ...
		  if("rfperf_tfbs.rds" %in% files){
			...
			mccdata_k562_on_k562_5kb <- rbind(mccdata_k562_on_k562_5kb,
			                                      perfdata[15,2])
}
...
all_rfperfs_cl_specific_valid$Chromosome <- rep(c("CHR1",
                                                  ...
                                                  "CHR21",
                                                  "CHR22"),20)
all_rfperfs_cl_specific_valid$Resolution <- rep(c(rep("5 kb", 21),
                                              rep("10 kb", 21),
                                              rep("25 kb", 21),
                                              rep("50 kb", 21),
                                              rep("100 kb", 21)), 4)
all_rfperfs_cl_specific_valid$Validation <- c(rep("GM12878 on K562", 21*5),
                                              rep("K562 on GM12878", 21*5),
                                              rep("GM12878 on GM12878", 21*5),
                                              rep("K562 on K562", 21*5))
...
all_rfperfs_cl_specific_valid$Resolution <- factor(all_rfperfs_cl_specific_valid$Resolution, levels = c("5 kb", "10 kb", "25 kb", "50 kb", "100 kb"))
