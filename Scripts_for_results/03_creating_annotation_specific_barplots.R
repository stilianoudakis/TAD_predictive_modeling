...
ggplot(all_rfperfs_a_p, aes(x=Annotation, y=Performance, fill=Tool)) +
  ...
  guides(fill=FALSE) +
  scale_fill_manual(values = c("#00468BFF", "#AD002AFF"))+
  theme_minimal() +
  theme_bw()+
  xlab("Genomic Class") + 
...
badata_k562_5kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/badata_k562_5kb_arrowhead_annotations.rds")
...
badata_k562_10kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/badata_k562_10kb_peakachu_annotations.rds")
