...
rfeperchr_k562_5kb_arrowhead_mean <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/rfeperchr_k562_5kb_arrowhead_mean.rds")
rfeperchr_k562_10kb_peakachu_mean <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/rfeperchr_k562_10kb_peakachu_mean.rds")

rfeperchr_summ_k562 <- rbind.data.frame(rfeperchr_k562_5kb_arrowhead_mean,rfeperchr_k562_10kb_peakachu_mean)
rfeperchr_summ_k562$Tool <- c(rep("Arrowhead", nrow(rfeperchr_k562_5kb_arrowhead_mean)),
                              rep("Peakachu", nrow(rfeperchr_k562_10kb_peakachu_mean)))

ggplot(rfeperchr_summ_k562, aes(x=Variables, y=Performance, color=Tool)) + 
  geom_line(size=2,) +
  geom_point(size=4, position = position_dodge(.9)) +
  geom_errorbar(aes(ymin=Performance-(PerformanceSD+.01), ymax=Performance+(PerformanceSD+.01)), 
                width=4, 
