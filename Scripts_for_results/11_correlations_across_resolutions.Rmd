...
```{r}
jaccard_mod <- function (query, reference, restrict = NULL, modified=TRUE) {
  if(isTRUE(modified)){
    int = sum(width(intersect(query, reference)))
    minunion = min(sum(as.numeric(width(intersect(query, reference)))),sum(as.numeric(width(union(query, reference)))))
    res = int/minunion
  }else{
...
```{r}
gm12878_5kb <- readRDS("Z:/TAD_data_analysis/GM12878/5kb/results_by_chr/CHR22/rus/distance/preciseTAD_holdout.rds")
gm12878_10kb <- readRDS("Z:/TAD_data_analysis/GM12878/10kb/results_by_chr/CHR22/rus/distance/preciseTAD_holdout.rds")
gm12878_25kb <- readRDS("Z:/TAD_data_analysis/GM12878/25kb/results_by_chr/CHR22/rus/distance/preciseTAD_holdout.rds")
gm12878_50kb <- readRDS("Z:/TAD_data_analysis/GM12878/50kb/results_by_chr/CHR22/rus/distance/preciseTAD_holdout.rds")
gm12878_100kb <- readRDS("Z:/TAD_data_analysis/GM12878/100kb/results_by_chr/CHR22/rus/distance/preciseTAD_holdout.rds")
