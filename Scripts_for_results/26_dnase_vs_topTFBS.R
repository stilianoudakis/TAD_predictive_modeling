...
#             "dnase_rad21_znf143",
#             "dnase_smc3_znf143",
#             "dnase_ctcf_rad21_smc3",
#             "dnase_rad21_smc3_znf143",
#             "dnase_smc3_znf143_ctcf",
#             "dnase_znf143_ctcf_rad21",
#             "dnase_ctcf_rad21_smc3_znf143")){
#    print(c(i,j))
#    
#    perfdata <- readRDS(paste0("/home/stilianoudakisc/TAD_data_analysis/GM12878/5kb/results_by_chr/",
#                               i, 
...
#saveRDS(badata_gm12878_5kb, "/home/stilianoudakisc/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_gm12878_topTFBS_combinations_dnase.rds")

badata_gm12878_5kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_gm12878_topTFBS_combinations_dnase.rds")

all_rfperfs_dnase <- cbind.data.frame(V1=badata_gm12878_5kb,
                                      Combination=rep(c("dnase",
                                                        "dnase_ctcf",
                                                        "dnase_rad21",
                                                        "dnase_smc3",
                                                        "dnase_znf143",
                                                        ...
                                                        "dnase_smc3_znf143_ctcf",
                                                        "dnase_znf143_ctcf_rad21",
                                                        "dnase_ctcf_rad21_smc3_znf143"),21),
...
all_rfperfs_dnase$Chromosome <- factor(all_rfperfs_dnase$Chromosome, levels = paste0("CHR", c(1:8,10:22)))
all_rfperfs_dnase$Combination <- factor(all_rfperfs_dnase$Combination, levels = c("dnase",
                                                                                  "dnase_ctcf",
                                                                                  "dnase_rad21",
                                                                                  "dnase_smc3",
                                                                                  "dnase_znf143",
...
all_rfperfs_dnase_ba <- all_rfperfs_dnase %>%
  dplyr::group_by(Combination) %>%
  dplyr::summarise(Performance = mean(V1, na.rm = TRUE),
                   PerformanceSD = sd(V1, na.rm = TRUE))


all_rfperfs_point <- rbind.data.frame(all_rfperfs_ba,all_rfperfs_dnase_ba)
all_rfperfs_box <- rbind.data.frame(all_rfperfs,all_rfperfs_dnase)


a1 <- ggplot(all_rfperfs_box, aes(x=reorder(Combination, V1, mean), y=V1, fill=Combination)) +
...
#saveRDS(badata_k562_5kb, "/home/stilianoudakisc/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_k562_topTFBS_combinations_dnase.rds")

badata_k562_5kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_k562_topTFBS_combinations_dnase.rds")

all_rfperfs_dnase <- cbind.data.frame(V1=badata_k562_5kb,
                                      Combination=rep(c("dnase",
                                                        "dnase_ctcf",
                                                        "dnase_rad21",
                                                        "dnase_smc3",
...
b1 <- ggplot(all_rfperfs_box, aes(x=reorder(Combination, V1, mean), y=V1, fill=Combination)) +
  geom_boxplot(outlier.shape = NA) +
  ylim(.50,.85) +
  guides(fill=FALSE) +
  theme_minimal() +
...
#saveRDS(badata_gm12878_10kb, "/home/stilianoudakisc/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_gm12878_topTFBS_combinations_peakachu_dnase.rds")

badata_gm12878_10kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_gm12878_topTFBS_combinations_peakachu_dnase.rds")

all_rfperfs_dnase <- cbind.data.frame(V1=badata_gm12878_10kb,
                                      Combination=rep(c("dnase",
                                                        "dnase_ctcf",
                                                        "dnase_rad21",
                                                        "dnase_smc3",
...
a3 <- ggplot(all_rfperfs_box, aes(x=reorder(Combination, V1, mean), y=V1, fill=Combination)) +
  geom_boxplot(outlier.shape = NA) +
  ylim(.50,.85) +
  guides(fill=FALSE) +
  theme_minimal() +
...
#saveRDS(badata_k562_10kb, "/home/stilianoudakisc/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_k562_topTFBS_combinations_peakachu_dnase.rds")

badata_k562_10kb <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/TADRF_holdout_k562_topTFBS_combinations_peakachu_dnase.rds")

all_rfperfs_dnase <- cbind.data.frame(V1=badata_k562_10kb,
                                      Combination=rep(c("dnase",
                                                        "dnase_ctcf",
                                                        "dnase_rad21",
                                                        "dnase_smc3",
...
b3 <- ggplot(all_rfperfs_box, aes(x=reorder(Combination, V1, mean), y=V1, fill=Combination)) +
  geom_boxplot(outlier.shape = NA) +
  ylim(.50,.85) +
  guides(fill=FALSE) +
  theme_minimal() +
