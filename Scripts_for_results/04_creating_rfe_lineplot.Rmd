...
```{r}
rfeperchr_summ_arrowhead <- rfeperchr_summ
rfeperchr_summ_peakachu <- rfeperchr_summ

rfeperchr_summ_gm12878 <- rbind.data.frame(rfeperchr_summ_arrowhead,rfeperchr_summ_peakachu)
rfeperchr_summ_gm12878$Tool <- c(rep("ARROWHEAD", nrow(rfeperchr_summ_arrowhead)),
                                 rep("PEAKACHU", nrow(rfeperchr_summ_peakachu)))
