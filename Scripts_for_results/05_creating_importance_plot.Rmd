...
```{r}
rfe.set.mat <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/impmat_gm12878_5kb_arrowhead.rds")
rfe.set.mat <- rfe.set.mat[-13,]
rfe.set.mat <- readRDS("Z:/TAD_data_analysis/miscellaneous/saved_rds_files/impmat_gm12878_10kb_peakachu.rds")
...
Heatmap(t(rfe.set.mat),
        ...
        cluster_rows=FALSE,
        clustering_distance_columns = "euclidean",
        clustering_method_columns = "complete", #"ward.D",
        show_row_names = FALSE,
